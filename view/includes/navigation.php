<nav class="navbar navbar-expand-lg navbar-light bg-light">
    <div class="container">
        ...
        <div class="collapse navbar-collapse" id="nav-items-collapse">
            <ul class="navbar-nav">
                <li class="nav-item <?php echo $page_name == "home" ? "active" : "" ?>"><a class="nav-link hover-underline-animation" href="index.php">Home</a></li>
                <li class="nav-item dropdown">
                    <a class="nav-link dropdown-toggle hover-overline-animation" href="#" id="afdelingen-items" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">Afdelingen</a>
                ...
                <li class="nav-item <?php echo $page_name == "agenda" ? "active" : "" ?>"><a class="nav-link hover-underline-animation" href="agenda.php">Agenda</a></li>
                <li class="nav-item <?php echo $page_name == "overons" ? "active" : "" ?>"><a class="nav-link hover-underline-animation" href="overons.php">Over ons</a></li>
                <li class="nav-item dropdown">
                    <a class="nav-link dropdown-toggle hover-overline-animation" href="#" id="vragen-items" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">Vragen</a>
                ...
                <li class="nav-item <?php echo $page_name == "contact" ? "active" : "" ?>"><a class="nav-link hover-underline-animation" href="contact.php">Contact</a></li>
            </ul>
        </div>
    </div>
</nav>